...
/**
An object of a CPropertyPageFrame-derived class is used by
CTreePropSheet to display a frame for the property pages.

Derived classes have to implement at least the Create() and the
GetWnd() method, which
returns a pointer to the CWnd-object of the window, that has been
...
public:
	CPropPageFrame();
	virtual	~CPropPageFrame() = default;
...
protected:
	...
	*/
	virtual void DrawMsg(CDC *pDc, const CRect &rect, LPCTSTR lpszMsg, DWORD dwFormat);
