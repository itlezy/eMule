...
//	void PrintUploadStatus();
	...
	bool			IsSlowDownloader()  const						{ return m_caughtBeingSlow > (6 * 1024); } // How many times was the client slow? As the update happens on a timer basis, this give some temporal depth
