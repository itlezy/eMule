...
protected:
	...
	afx_msg void OnHelp();
	afx_msg void OnNmClickList(LPNMHDR, LRESULT*);
	afx_msg void OnNmDblClkActionlist(LPNMHDR, LRESULT *pResult);
	afx_msg void OnNmRClickActionlist(LPNMHDR, LRESULT *pResult);
