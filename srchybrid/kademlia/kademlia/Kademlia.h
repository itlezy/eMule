...
namespace Kademlia
{
	...
	public:
		...
		static void NoteBootstrapResponse(const CUInt128 &uID, uint16 uUDPPort);
	...
	private:
		...
		static bool m_bBootstrapPending;
		static CUInt128 m_uBootstrapPendingID;
		static uint16 m_uBootstrapPendingUDPPort;
