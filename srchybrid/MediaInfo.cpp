 ...
 *
 * The probe checks a fixed byte sequence at a fixed offset and may optionally
 * use specialized validation for container-specific formats.
 */
...
/** \brief Detects a file MIME type from known signatures or URLMon sniffing. */
