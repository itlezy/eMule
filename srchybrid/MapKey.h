...
// use this class if the hash is stored somewhere else (and stays valid as long as this object exists)
...
// use this class if the hash is stored somewhere inside the key (in any case safer but needs more memory)
