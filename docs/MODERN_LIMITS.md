...
### 1. Connection Budget Defaults Are Too Low
...
### 2. Per-Client Upload Ceiling Is Too Low
...
### 3. Socket Buffers Are Undersized
...
### 4. Disk Buffering Defaults Are Conservative
...
### 5. Queue And Source Limits Are Still Small
...
### 6. Several Timeouts Are Long And Old
...
### Connection And Socket Defaults
...
### File, Queue, And Source Defaults
...
## Settings To Expose In The Advanced Tree
...
### Phase 1: Raise The Defaults Only
...
### Phase 2: Replace Compile-Time Magic With Preferences Where Practical
...
### 3. `MaxConnectionsPerFiveSeconds`
...
```text
Implement docs\MODERN_LIMITS.md in phased chunks.
...
```text
Start Phase 1 of docs\MODERN_LIMITS.md now.
