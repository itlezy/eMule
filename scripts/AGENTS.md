...
- PowerShell scripts in this directory must use the `category-purpose.ps1` naming convention.
- Matching launcher wrappers in this directory must use the `category-purpose.cmd` naming convention.
